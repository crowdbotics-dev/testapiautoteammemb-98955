...
## Project Structure
    ...
    ├── testapiautoteammemb_98955  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_98955`
...
2. Clone this repo and `cd testapiautoteammemb_98955`
